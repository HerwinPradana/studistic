                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">NIM/NIP</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select id="user-type" class="form-control" name="user_type" required>
                                	<option value="0" @if(old('user_type') == 0) selected @endif>Student</option>
                                	<option value="1" @if(old('user_type') == 1) selected @endif>Teacher</option>
                                </select>
                            </div>
                        </div>
